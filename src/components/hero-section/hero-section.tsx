...
export function HeroSection() {
	return (
		...
		>
			<div
				className={`
          grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[20rem]
          md:h-[36rem] items-center
        `}
			>
				<div
					className={`
          ...
          `}
            ...
            `}
					>
						...
						<div
							className={`
              text-white flex flex-col items-center gap-2 mt-5 md:items-start
                lg:items-start
              `}
						>
				...
				<div
					className={`
            relative h-[20rem] hidden md:h-full order-first md:order-last
            items-center justify-center md:flex lg:flex
          `}
				>
					<Image
