...
export function FeatureSection() {
	return (
		<section
			className={`
        container bg-gray-700 grid gap-6 md:grid-cols-2 py-8 md:py-10
      `}
		>
			<div
				className={`
          flex flex-col gap-4 rounded-lg p-6 bg-gray-500 md:p-12
        `}
			>
				<span
					className={`
            text-body-tag text-blue-200 bg-blue-400 px-2 py-1 rounded-sm
            uppercase w-fit
          `}
				>
					Simples
        ...
        `}
          ...
          `}
			...
			<div className="col-span-full flex flex-col gap-2">
				<div
					className={`
            grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg
